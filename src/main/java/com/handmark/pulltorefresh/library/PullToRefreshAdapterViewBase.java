...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public MySrcollListener mySrcollListener = null; 
	public MySrcollListenerTwo mySrcollListener2 = null; 
	
	public interface MySrcollListener{
		public void actionMyScrollEvent(int state);
	}
	
	public interface MySrcollListenerTwo{
		public void actionMyScrollEvent(int firstVisibleItem, int visibleItemCount,
				int totalItemCount);
	}
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if(null != mySrcollListener2){
			mySrcollListener2.actionMyScrollEvent(firstVisibleItem, visibleItemCount,
					totalItemCount);
		}
	}
	...
	public final void onScrollStateChanged(final AbsListView view, final int state) {
		...
		if(null != mySrcollListener){
			mySrcollListener.actionMyScrollEvent(state);
		}
	}
	
	public void setMyScrollListener(MySrcollListener mySrcollListener){
		this.mySrcollListener = mySrcollListener;
	}
	
	public void setMyScrollListenerT(MySrcollListenerTwo mySrcollListener2){
		this.mySrcollListener2 = mySrcollListener2;
	}
