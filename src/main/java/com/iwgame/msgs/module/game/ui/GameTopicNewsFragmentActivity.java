/**      
* GameTopicNewsFragmentActivity.java Create on 2014-4-21     
*      
...
/** 
 * @ClassName: GameTopicNewsFragmentActivity 
 * @Description: TODO(贴吧 -新闻) 
 * @author chuanglong
 * @date 2014-4-21 下午5:09:25 
 * @Version 1.0
 * 
 */
public class GameTopicNewsFragmentActivity extends BaseFragmentActivity {
    private long gid = 0 ;
    /*
     * (non-Javadoc)
     * 
	...
	bundle.putInt(SystemConfig.BUNDLE_NAME_GETTOPICLIST_TAGID, MsgsConstants.POSTBAR_TAGS_ID_NEWS);
