 ...
 * @Description: 聊天弹出菜单组件
 * @author 王卫
 * @date 2013-12-13 下午2:32:37
 * @Version 1.0
 * 
 */
public class ChatGroupMemberPopWindow extends PopupWindow implements OnClickListener, OnKeyListener {
	 ...
	 * @param yoff
	 */
	public ChatGroupMemberPopWindow(Context context, List<View> items, View anchor, int xoff, int yoff) {
	 ...
	 * @param bgResid
	 */
	public ChatGroupMemberPopWindow(Context context, View anchor, int xoff, int yoff, int bgResid) {

		super(View.inflate(context, R.layout.chat_group_members_menu_view, null), LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, true);
	...
	public void setContentItems(List<View> list) {
		...
		int padding = DisplayUtil.dip2px(context, 130);
		real_xoff = (displayWidth - padding)/2;
	...
	public boolean onKey(View v, int keyCode, KeyEvent event) {
		if (event.getAction() == KeyEvent.ACTION_DOWN) {
			...
			case KeyEvent.KEYCODE_MENU:
				ChatGroupMemberPopWindow.this.dismiss();
				break;
			}
		}
		return false;
