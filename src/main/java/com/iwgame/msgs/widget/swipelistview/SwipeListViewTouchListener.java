...
package com.iwgame.msgs.widget.swipelistview;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
        ...
        if (swipeOpenOnLongPress) {
            frontView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    /***
                     * chuanglong 增加排他人性 2014.02.21
                     */
                    closeOpenedItems(downPosition);
    ...
    /**
     * chuanglong add by 2014.02.21 
     * Close all opened items， exclude postion
     * @param excludePosition  exclude postion
     */
    void closeOpenedItems(int excludePosition) {
        if (opened != null) {
            int start = swipeListView.getFirstVisiblePosition();
            int end = swipeListView.getLastVisiblePosition();
            for (int i = start; i <= end; i++) {
