/**      
 * CrashHandler.java Create on 2014-1-19     
 *      
...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	private void postReport(File file) {
		// 发送错误报告到服务器
		if (mDeviceCrashInfo.containsKey(STACK_TRACE) && mDeviceCrashInfo.get(STACK_TRACE) != null) {
			String str = (String) mDeviceCrashInfo.get(STACK_TRACE);
			...
			}, null, str, null, imsi, systemVersion, networkType, phoneModel, mac, position);
