...
public class AlbumHelper {
	...
	List<ImageBucket> bucketList = null;
	...
	private void getThumbnail(){
		...
		Cursor cursor=cr.query(Thumbnails.EXTERNAL_CONTENT_URI, projection, null, null, "image_id DESC");
	...
	public String getOriginalImagePath(String imageId){
		...
		Cursor cursor=cr.query(Media.EXTERNAL_CONTENT_URI, projection, Media._ID+"="+imageId, null, null);
		if(cursor!=null){
			cursor.moveToFirst();
